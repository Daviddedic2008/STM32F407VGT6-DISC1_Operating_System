...
// We are mapping EXTI(external interrupt) to trigger on the falling edge of the clock pin
// Then we read data pin to recieve a bit of data from the keyboard
